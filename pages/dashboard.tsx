...
import styles from '../styles/Dashboard.module.css'; // Import our new CSS
...
export default function DashboardPage() {
  ...
  const handleWithdraw = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase.from('withdrawals').insert({ user_id: profile.id, amount: amount, wallet_address: walletAddress, status: 'pending' });
  ...
  return (
    <div style={{ backgroundColor: '#111827', minHeight: 'calc(100vh - 142px)', color: 'white', padding: '1rem 1.5rem', overflowX: 'hidden' }}>
        ...
        <FadeInSection>
          ...
          <div className={styles.dashboardGrid}>
            ...
            <div className={styles.card}>
              ...
              <Link href="/deposit" className="pro-button" style={{width: '100%', textAlign: 'center'}}>Deposit Funds</Link>
            </div>
            <div className={`${styles.card} ${styles.withdrawalCard}`}>
